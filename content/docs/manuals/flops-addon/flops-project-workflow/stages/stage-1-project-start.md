...
To start a project we need to request the FLOps Manager (_which is part of FLOps Management_) to create one.
...
Besides the FLOps manager logs, this is the primary way for you _(and especially common users)_ to keep up with your projects' current _(internal)_ state.
