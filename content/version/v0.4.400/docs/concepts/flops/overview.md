...
FLOps is an [Oakestra Addon](../../oakestra-extensions/addons/) that enables streamlined and accelerated practical FL workflows through many of its automation features.
...
See the [FLOps Manuals](../../../manuals/flops-addon/overview/) for concrete instructions.

The [Oakestra CLI](../../../getting-started/deploy-app/deploy-cli/#the-oak-cli) supports a [set of commands](../../../manuals/cli/features/flops/#oak-addon-flops) to work with FLOps.
{{< /details >}}
...
**FLOps** stands for _Federated Learning Operations_.
It is inspired by the field of _MLOps_ that enhances ML with DevOps practices.
{{< /callout >}}
