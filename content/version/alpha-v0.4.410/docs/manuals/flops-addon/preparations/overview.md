...
Move into your **Root Orhcestrator** machine and enable the FLOps management addon using:

```bash
oak addon flops restart
```
...
{{< callout context="note" title="Cleanup your FLOps Management" icon="outline/info-circle" >}}
