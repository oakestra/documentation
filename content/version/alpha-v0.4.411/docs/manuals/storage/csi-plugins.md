...
An example is the [_csi.oakestra.io/hostpath_](../hostpath) plugin used to support Volumes in Oakestra. To install such plugins, perform the following steps.
...
You need to develop a custom _CSI Adapter_ and deploy it as an Oakestra Plugin along with the CSI Plugin Controller.
