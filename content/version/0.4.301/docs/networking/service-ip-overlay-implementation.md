...
The Environment Manager can now answer the proxy with the _virtual layer_ and _physical layer_ addresses resolving the previous cache miss and the balancing policy metadata associated with the address. In this case the response will look like this:
